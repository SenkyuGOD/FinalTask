...
public class CommandProvider {
    ...
    CommandProvider(){
        ...
        repository.put(CommandName.ADD_PRODUCT_TO_BUCKET, new AddProductToBucketCommand());
        repository.put(CommandName.DELETE_PRODUCT_FROM_BUCKET, new DeleteProductFromBucketCommand());
        repository.put(CommandName.DISPLAY_BUCKET, new DisplayBucketCommand());
